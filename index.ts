...
import type { EnrollmentStatus } from './models/EnrollmentRecord.model.js';
import { describeCourse } from './models/course.model.js';
import type { Course, CourseStatus } from './models/course.model.js';
...
const errorRes: ApiResponse<Student> = { status: 'error', message: 'Not found', statusCode: 404 };
console.log(renderResponse(errorRes, (s: Student) => s.name));
